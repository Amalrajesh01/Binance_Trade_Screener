...
# ---------------------------
# 🔔 Scheduler setup (same Flask app)
# ---------------------------
...
# 🚀 Run Smart FVG Screener at 5:32am, 9:32am, 1:32pm, 5:32pm, 9:32pm, 1:32am IST
scheduler.add_job(
    func=run_screener,
    trigger=CronTrigger(hour="5,9,13,17,21,1", minute=32, timezone="Asia/Kolkata"),
    id="smart_fvg_runs",
    replace_existing=True,
)
...
# Keep your index route
@app.route("/")
def index():
    return "🚀 Binance Smart FVG Strategy running with AI Scheduler"
